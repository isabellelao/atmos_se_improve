...
%         subplot(3,5,5)
        ...
        plot(movmean_se,'color','#696969','linewidth',1)
        text(360,1,{'North Northeast'},'fontsize',16,'horizontalalignment','right');
        ...
        ax.XLim = [1 365];     
        hold on
        bin1(:,count_bin1) = movmean_se(1:365);
...
%         subplot(3,5,1)
        ...
        movmean_se = movmean(station_average_Se(i).all,30.4,'omitnan');
        plot(movmean_se,'color','#696969','linewidth',1)
        text(360,1.2,{'West'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se concentration (ng/m^3)')
        set(gca, 'YScale', 'log')  
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
        ...
        hold on
        bin2(:,count_bin2) = movmean_se(1:365);
...
%         subplot(3,5,10)
        ...
        movmean_se = movmean(station_average_Se(i).all,30.4,'omitnan');
        plot(movmean_se,'color','#696969','linewidth',1)
        text(360,2.9,{'Northeast'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se concentration (ng/m^3)')
        set(gca, 'YScale', 'log')  
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
        ...
        ax.XLim = [1 365];           
        hold on
        bin3(:,count_bin3) = movmean_se(1:365);
...
%         subplot(3,5,15)
        ...
        movmean_se = movmean(station_average_Se(i).all,30.4,'omitnan');
        plot(movmean_se,'color','#696969','linewidth',1)
        text(360,1.4,{'Midwest'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se concentration (ng/m^3)')
        set(gca, 'YScale', 'log')  
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
        ...
        hold on 
        bin4(:,count_bin4) = movmean_se(1:365);
...
%         subplot(3,5,6)
        ...
        movmean_se = movmean(station_average_Se(i).all,30.4,'omitnan');
        plot(movmean_se,'color','#696969','linewidth',1)
        text(360,0.5,{'Southwest'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se concentration (ng/m^3)')
        set(gca, 'YScale', 'log') 
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
        ...
        ax.XLim = [1 365];  
        hold on 
        bin5(:,count_bin5) = movmean_se(1:365);
...
%         subplot(3,5,13)
        ...
        movmean_se = movmean(station_average_Se(i).all,30.4,'omitnan');
        plot(movmean_se,'color','#696969','linewidth',1)
        text(360,1.4,{'Southeast'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se concentration (ng/m^3)')
        set(gca, 'YScale', 'log')  
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
...
%         subplot(3,5,11)
        ...
        movmean_se = movmean(station_average_Se(i).all,30.4,'omitnan');
        plot(movmean_se,'color','#696969','linewidth',1)
        text(360,1.5,{'Unclassified'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se concentration (ng/m^3)')
        set(gca, 'YScale', 'log')  
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
...
median_se_bin1 = median(bin1,2);
median_se_bin2 = median(bin2,2);
median_se_bin3 = median(bin3,2);
median_se_bin4 = median(bin4,2);
median_se_bin5 = median(bin5,2);
median_se_bin6 = median(bin6,2);
