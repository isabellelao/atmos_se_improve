...
%         subplot(3,5,5)
        subplot(3,6,[5 6])
        plot(station_average_MF(i).enhancement,'color','#696969','linewidth',1)
        text(360,1.9e-4,{'North Northeast'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se:PM_{2.5}')
        set(gca, 'YScale', 'log')  
        ax = gca;
        ...
        ax.XLim = [1 365];     
        hold on
        bin1(:,count_bin1) = station_average_MF(i).enhancement;
...
%         subplot(3,5,1)
        subplot(3,6,[3 4])
        plot(station_average_MF(i).enhancement,'color','#696969','linewidth',1)
        text(360,2e-4,{'West'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se:PM_{2.5}')
        set(gca, 'YScale', 'log')  
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
...
%         yticks([0.25 0.5 0.75 1]);            
        hold on
        bin2(:,count_bin2) = station_average_MF(i).enhancement;
...
%         subplot(3,5,10)
        subplot(3,6,[11 12])
        plot(station_average_MF(i).enhancement,'color','#696969','linewidth',1)
        text(360,4e-4,{'Northeast'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se:PM_{2.5}')
        set(gca, 'YScale', 'log')  
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
        ...
        ax.XLim = [1 365];           
        hold on
        bin3(:,count_bin3) = station_average_MF(i).enhancement;
...
%         subplot(3,5,15)
        subplot(3,6,[15 16])
        plot(station_average_MF(i).enhancement,'color','#696969','linewidth',1)
        text(360,1.8e-4,{'Midwest'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se:PM_{2.5}')
        set(gca, 'YScale', 'log')  
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
...
%         yticks([0.3 0.6 0.9 1.2]);               
        hold on 
        bin4(:,count_bin4) = station_average_MF(i).enhancement;
...
%         subplot(3,5,6)
        subplot(3,6,[9 10])
        plot(station_average_MF(i).enhancement,'color','#696969','linewidth',1)
        text(360,1.8e-4,{'Southwest'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se:PM_{2.5}')
        set(gca, 'YScale', 'log') 
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
        ...
        ax.XLim = [1 365];  
        hold on 
        bin5(:,count_bin5) = station_average_MF(i).enhancement;
...
%         subplot(3,5,13)
        subplot(3,6,[17 18])
        plot(station_average_MF(i).enhancement,'color','#696969','linewidth',1)
        text(360,1.7e-4,{'Southeast'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se:PM_{2.5}')
        set(gca, 'YScale', 'log')  
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
...
%         yticks([0.25 0.5 0.75 1]);
        hold on
        bin6(:,count_bin6) = station_average_MF(i).enhancement;
...
%         subplot(3,5,11)
        subplot(3,6,[13 14])
        plot(station_average_MF(i).enhancement,'color','#696969','linewidth',1)
        text(360,3.2e-4,{'Unclassified'},'fontsize',16,'horizontalalignment','right');
        ylabel('Se:PM_{2.5}')
        set(gca, 'YScale', 'log')  
        ax = gca;
        ax.XTick = ([15 45 74 105 135 166 196 227 258 288 319 349]);
...
subplot(3,6,[5 6])
    yline(mean(mean(bin1,'omitnan')),'--k','linewidth',2)
    plot(mean(bin1,2),'color','#fcca03','linewidth',3)
subplot(3,6,[3 4])
    yline(mean(mean(bin2,'omitnan')),'--k','linewidth',2)
    plot(mean(bin2,2),'color','#23c221','linewidth',3)
subplot(3,6,[11 12])
    yline(mean(mean(bin3,'omitnan')),'--k','linewidth',2)
    plot(mean(bin3,2),'color','#A2142F','linewidth',3)
subplot(3,6,[15 16])
    yline(mean(mean(bin4,'omitnan')),'--k','linewidth',2)   
    plot(mean(bin4,2),'color','#a830db','linewidth',3)
subplot(3,6,[9 10])
    yline(mean(mean(bin5,'omitnan')),'--k','linewidth',2)    
    plot(median(bin5,2),'color','#db30a2','linewidth',3)    
subplot(3,6,[17 18])
    yline(mean(mean(bin6,'omitnan')),'--k','linewidth',2)
    plot(mean(bin6,2),'color','#0072BD','linewidth',3)


%% variable save for all_medians
median_enh_bin1 = median(bin1,2);
median_enh_bin2 = median(bin2,2);
median_enh_bin3 = median(bin3,2);
median_enh_bin4 = median(bin4,2);
median_enh_bin5 = median(bin5,2);
median_enh_bin6 = median(bin6,2);

mean_enh_bin1 = mean(bin1,2,'omitnan');
mean_enh_bin2 = mean(bin2,2,'omitnan');
mean_enh_bin3 = mean(bin3,2,'omitnan');
mean_enh_bin4 = mean(bin4,2,'omitnan');
mean_enh_bin5 = mean(bin5,2,'omitnan');
mean_enh_bin6 = mean(bin6,2,'omitnan');
